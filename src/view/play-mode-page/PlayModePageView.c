...
#include "../welcome-page/WelcomePageView.h"
...
void initPlayModePageView() {
    ...
    const TextButton pvpButton = {"pvp-btn", "P vs P", FLAT_BUTTON,{400, 800}, {284, 108}, initPlayPageView};
    const TextButton pvmButton = {"pvm-btn", "P vs M", FLAT_BUTTON,{900, 800}, {284, 108}, initWelcomePageView};
